...
impl Theme {
    pub fn amni_dark() -> Self {
        Self {
            id: "amni-dark".into(),
            name: "Amni Scient".into(),
            bg_primary: "#08090B".into(),
            bg_secondary: "#0D0F12".into(),
            bg_tertiary: "#111418".into(),
            bg_hover: "#161A20".into(),
            border: "#20242B".into(),
            text_primary: "#EDEFF2".into(),
            text_secondary: "#A7ADB6".into(),
            accent: "#C89B4E".into(),
            accent_hover: "#E2BC7C".into(),
            accent_glow: "rgba(200, 155, 78, 0.18)".into(),
            danger: "#FF6B6B".into(),
            success: "#4ADE80".into(),
            warning: "#E8B04B".into(),
            gradient_start: "#C89B4E".into(),
            gradient_mid: "#E2BC7C".into(),
            gradient_end: "#5EEAD4".into(),
            tab_active: "#111418".into(),
    ...
    pub fn amni_light() -> Self {
        Self {
            ...
            bg_secondary: "#e4e8ef".into(),
            bg_tertiary: "#d8dee8".into(),
            bg_hover: "#cfd6e2".into(),
            border: "#c0c8d4".into(),
            text_primary: "#1a1f2e".into(),
            text_secondary: "#5a6577".into(),
            accent: "#0077cc".into(),
            accent_hover: "#0099ee".into(),
            accent_glow: "rgba(0, 119, 204, 0.12)".into(),
            danger: "#d63031".into(),
            success: "#00b894".into(),
            warning: "#e17055".into(),
            ...
            tab_active: "#f5f7fa".into(),
            tab_inactive: "#e4e8ef".into(),
            background_image: None,
            background_opacity: 1.0,
            font_family: "-apple-system, BlinkMacSystemFont, 'Segoe UI', 'Inter', Helvetica, Arial, sans-serif".into(),
    ...
    pub fn amni_paper_sunset() -> Self {
        Self {
            ...
            bg_secondary: "#f0e4d4".into(),
            bg_tertiary: "#e8d8c4".into(),
            bg_hover: "#e0cfb8".into(),
            border: "#d4b896".into(),
            ...
            tab_active: "#fdf6ec".into(),
            tab_inactive: "#f0e4d4".into(),
            background_image: None,
            background_opacity: 1.0,
