...
<h2>Theme</h2><div>__THEMES__</div>
...
:root{__THEME__}
body{font:15px -apple-system,'Segoe UI',Roboto,Arial,sans-serif;background:var(--bg);color:var(--text);display:flex;flex-direction:column;align-items:center;min-height:100vh;margin:0;padding-top:14vh}
h1{font-size:34px;letter-spacing:.5px;margin:0 0 6px;color:var(--accent)}
